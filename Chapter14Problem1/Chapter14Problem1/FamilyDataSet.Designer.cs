...
namespace Chapter14Problem1 {
    ...
    public partial class FamilyDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string FirstName, string LastName, string Relationship, string Hometown, string Age) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Relationship {
                get {
                    try {
                        return ((string)(this[this.tableTable.RelationshipColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Chapter14Problem1.FamilyDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([FirstName], [LastName], [Relationship], [Hometown], [" +
                "Age]) VALUES (@FirstName, @LastName, @Relationship, @Hometown, @Age);\r\nSELECT Id" +
                ", FirstName, LastName, Relationship, Hometown, Age FROM [Table] WHERE (Id = SCOP" +
                "E_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [FirstName] = @FirstName, [LastName] = @LastName, [Relationship] = @Relationship, [Hometown] = @Hometown, [Age] = @Age WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Relationship = 1 AND [Relationship] IS NULL) OR ([Relationship] = @Original_Relationship)) AND ((@IsNull_Hometown = 1 AND [Hometown] IS NULL) OR ([Hometown] = @Original_Hometown)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT Id, FirstName, LastName, Relationship, Hometown, Age FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Chapter14Problem1.Properties.Settings.Default.FamilyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Relationship, Hometown, Age FROM dbo.[Table]";
        ...
        public virtual int Fill(FamilyDataSet.TableDataTable dataTable) {
        ...
        public virtual FamilyDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FamilyDataSet.TableDataTable dataTable = new FamilyDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FamilyDataSet.TableDataTable dataTable) {
        ...
        public virtual int Update(string FirstName, string LastName, string Relationship, string Hometown, string Age, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Relationship, string Original_Hometown, string Original_Age, int Id) {
            if ((FirstName == null)) {
